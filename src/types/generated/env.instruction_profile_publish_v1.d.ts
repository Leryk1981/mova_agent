...
/**
 * Envelope for publishing a MOVA instruction profile to an executor or guard.
 */
export interface EnvInstructionProfilePublishV1 {
  ...
  profile: DsInstructionProfileCoreV1;
  /**
