...
export function validateRequest(data: any): { isValid: boolean; errors?: any[] } {
  ...
  if (!isValid) {
    return {
      isValid: false,
      errors: validateToolDoorRequestV0.errors ? [...validateToolDoorRequestV0.errors] : undefined,
    };
  }
  return { isValid: true };
}
...
export function validateReceipt(data: any): { isValid: boolean; errors?: any[] } {
  ...
  if (!isValid) {
    return {
      isValid: false,
      errors: validateToolDoorReceiptV0.errors ? [...validateToolDoorReceiptV0.errors] : undefined,
    };
  }
  return { isValid: true };
}
