...
This table lists tested and supported combinations of MOVA Agent runtime, MOVA SDK CLI, core engine, and schema set (`@leryk1981/mova-spec`). Always align your versions with the latest row. Recommended stack: Agent 0.1.1 + core-engine 0.1.1 + executors 0.1.1 + spec 4.1.1.
